...
namespace Structured_Programming.Controllers
{
    public class SearchController : Controller
    {
        ...
        public ActionResult Index(int? page, SearchOptionsModel model)
        {
            ...
            // All items is queried first to minimize connection to database
            ...
            {
                flag = true;
                itemsToDisplay = itemsToDisplay.Union(allItems.Where(row => row.Trade.Contains(s))).ToList();
            }
            ...
            {
                flag = true;
                itemsToDisplay = itemsToDisplay = allItems.Where(row => row.Name.Contains(s)).ToList();
            }
